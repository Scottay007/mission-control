...
const F = [
  {
    ...
    steps: [
      ...
      {
        question: "Motor engage when pedaling?",
        conclusion: "Check: speed sensor, brake cutoffs, error codes, torque sensor."
      },
      {
        question: "Battery charged?",
        conclusion: "Check power connector, corrosion, water damage. If battery swollen, stop using."
      }
    ]
  },
  {
    ...
    steps: [
      {
        question: "Battery age?",
        options: [
          { label: "Under 2yr", next: 1 },
          { label: "Over 2yr", next: 1 }
        ]
      },
      {
        question: "Assist level?",
        conclusion: "Eco vs Turbo = 2-3x range difference. Check tire pressure (-15% if low). Old battery loses 10-30%."
      }
    ]
  }
];

export default function EBikeFlow() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <p className="text-text-muted text-sm mb-6">Step-by-step e-bike diagnosis.</p>
        <div className="flex flex-wrap gap-2 mb-8">
          {F.map((f, i) => (
            <button
              ...
              style={af === i ? { backgroundColor: '#22C55E' } : {}}
            >
              {f.name}
            </button>
          ))}
        ...
        {s && (
          <div className="mc-card p-6">
            ...
            {s.conclusion && (
              <div className="mt-4 p-4 rounded-mc border-2" style={{ borderColor: '#22C55E40' }}>
                <p className="font-bold mb-1" style={{ color: '#22C55E' }}>Diagnosis:</p>
